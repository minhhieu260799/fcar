...
public interface SegmentRepository extends JpaRepository<Segment, Long> {
    ...
    // Các phân khúc (chưa xóa) của một dòng xe, dùng cho cascade enable/disable
    ...
    // Các phân khúc còn sử dụng được cho dropdown (brand + model + segment đều active, chưa xóa)
