...
-- Bảng brands: lưu hãng xe (Toyota, Honda, ...)
CREATE TABLE brands (
    id BIGINT IDENTITY(1,1) PRIMARY KEY,
    name NVARCHAR(150) NOT NULL UNIQUE,
...
-- Bảng car_models: lưu dòng xe theo từng hãng (Vios, Civic, ...)
...
-- Bảng segments: lưu phiên bản xe (gắn với từng dòng xe cụ thể, VD: Vios có 1.5E-MT, 1.5E-CVT)
...
-- Bảng car_definitions: mẫu xe = hãng + dòng xe + phiên bản + năm (VD: Toyota Vios 1.5E-MT 2026)
