...
import com.fcar.modules.user.service.SessionService;
import com.fcar.modules.user.service.UserService;
import jakarta.validation.constraints.Email;
import jakarta.validation.constraints.NotBlank;
import jakarta.validation.constraints.Pattern;
import jakarta.validation.constraints.Size;
import java.util.Locale;
import com.fcar.core.util.PasswordPolicy;
import lombok.Data;
...
public class ForgotPasswordController {
    ...
    public String resetPassword(@Validated(OnReset.class) @ModelAttribute("form") ForgotPasswordForm form,
        ...
        if (!PasswordPolicy.matches(form.getNewPassword())) {
            bindingResult.rejectValue(
                    "newPassword",
                    "password.policy",
