package com.fcar.modules.testdrive.service;
...
public class ContactTestDriveEmailHtmlService {
    ...
    private static String formatDt(LocalDateTime t) {
        ...
        return HtmlEscapes.html(t.format(DT_DISPLAY));
    }
    ...
    private String carLine(CarInventory inv) {
        ...
        return HtmlEscapes.html(carDefinitionLabelFormatter.format(inv.getCarDefinition()));
    }
    ...
    private String branchLine(Branch b) {
        ...
        return HtmlEscapes.html(b.getName());
    }

    private String contactSummaryRows(ContactRequest c) {
        User u = c.getUser();
        String khach = u != null ? HtmlEscapes.html(u.getFullName()) : "—";
        String email = u != null ? HtmlEscapes.html(u.getEmail()) : "—";
        String sdt = u != null && u.getPhone() != null ? HtmlEscapes.html(u.getPhone()) : "—";
        return """
                ...
                HtmlEscapes.html(c.getStatus().getVietnameseLabel()));
    }
    ...
    private String testDriveSummaryRows(TestDriveBooking b) {
        ...
        return """
                ...
                HtmlEscapes.html(b.getStatus().getVietnameseLabel()));
    }
