...
public interface CarDefinitionRepository extends JpaRepository<CarDefinition, Long>, JpaSpecificationExecutor<CarDefinition> {
     ...
     * Màu và thông số khác được nạp trong {@link com.fcar.modules.catalog.service.CarQueryService#findListedDefinitionForDetail}.
     */
    ...
    /**
     * Niêm yết giống {@link #findListedIds(Pageable)}, lọc theo chuỗi (hãng, dòng, phiên bản, năm SX).
