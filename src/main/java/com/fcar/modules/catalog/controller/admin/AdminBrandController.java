...
/** Phân công: Hiếu — quản lý hãng (admin). */
@Controller
...
public class AdminBrandController {
    ...
    public String create(@Valid @ModelAttribute("form") BrandForm form,
        ...
        for (Brand existing : brandRepository.findAll()) {
            ...
            if (!existName.isEmpty() && !newName.isEmpty() && existName.equalsIgnoreCase(newName)) {
                bindingResult.rejectValue("name", "name.exists", "Tên hãng đã tồn tại");
                break;
            }
        }
        ...
        redirectAttributes.addFlashAttribute("success", "Thêm hãng thành công.");
    ...
    public String update(@PathVariable Long id,
        ...
        if (inUse) {
            ...
            model.addAttribute("error",
                    "Không thể thay đổi hãng vì có xe đang hoạt động");
            return "admin/brands/list";
        }
        ...
        brand.setName(form.getName());
        brandRepository.save(brand);
        redirectAttributes.addFlashAttribute("success", "Cập nhật hãng thành công.");
        return "redirect:/admin/brands";
    }
    ...
    public String disable(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("success", "Đã tạm ngưng hãng và các mục liên quan.");
        return "redirect:/admin/brands";
    }
    ...
    public String enable(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("success", "Đã bật hoạt động hãng và các mục liên quan.");
        return "redirect:/admin/brands";
    }
    ...
    public String delete(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        ...
        if (carModelRepository.existsByBrandAndDeletedFalse(brand)) {
            redirectAttributes.addFlashAttribute("error",
                    "Hãng không thể xóa khi đã tồn tại dòng xe trực tiếp.");
            return "redirect:/admin/brands";
        }
        brandRepository.delete(brand);
        redirectAttributes.addFlashAttribute("success", "Đã xóa hãng.");
        return "redirect:/admin/brands";
    }
